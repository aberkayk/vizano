  ...
  if (isFloating) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-2xl ring-4 ring-green-500/20 transition-all duration-300 hover:scale-110 group"
